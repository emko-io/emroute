...
Meta-issue — all items tracked in their own issue files. Shadow DOM cross-boundary resolved (by design). data-ssr bloat resolved. isLeaf fix addressed triple-rendering. Remaining items (GET form search, widget no-JS audit) tracked separately. Resolved 2026-03-05.
